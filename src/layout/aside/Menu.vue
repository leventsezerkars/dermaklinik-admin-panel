<template>
  ...
  <ScrollableContent
    ...
    header="#kt_aside_logo"
    footer="#kt_aside_footer"
    body="#kt_aside_menu"
  >
    <!--begin::Menu-->
    <div
    ...
    >
      <template v-for="(item, i) in MainMenuConfig" :key="i">
        ...
        <template v-for="(menuItem, j) in item.pages" :key="j">
          ...
          <div
            v-if="
              menuItem.sectionTitle && userHasPermission(menuItem.permissions)
            "
          ...
          >
            ...
            >
              <template v-for="(item2, k) in menuItem.sub" :key="k">
                <div
                  v-if="item2.heading && userHasPermission(item2.permissions)"
                  class="menu-item"
                >
                  <router-link
                    class="menu-link"
                ...
                <div
                  ...
                  :class="{ show: hasActiveChildren(item2) }"
                  class="menu-item menu-accordion"
                  data-kt-menu-sub="accordion"
                  data-kt-menu-trigger="click"
                >
...
export default defineComponent({
  ...
  setup() {
    ...
    const hasActiveChildren = (match) => {
      ...
      let hasMatch = false;
      match.sub.forEach((x) => {
        hasMatch = x.routeName == route.name;
        if (hasMatch) return;
      });
    ...
    const userHasPermission = (permissions: string[]) => {
